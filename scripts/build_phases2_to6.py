...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build linked TopoCross-SWIS Phases 2 through 6")
    ...
    result = {"phase2": phase2, "phase3": phase3, "phase4": phase4, "phase5": phase5, "phase6": phase6}
